...
import iconIe from '@fortawesome/fontawesome-free/svgs/brands/ie.svg'
import iconQQ from '@fortawesome/fontawesome-free/svgs/brands/QQBrowser.svg'
import icon360 from '@fortawesome/fontawesome-free/svgs/brands/360.svg'
import iconEdge from '@fortawesome/fontawesome-free/svgs/brands/edge.svg'
import iconWeChat from '@fortawesome/fontawesome-free/svgs/brands/wechat.svg'
import iconOther from '@fortawesome/fontawesome-free/svgs/brands/unknow.svg'
